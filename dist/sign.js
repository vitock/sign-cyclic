...
constructor(e,t,o,i){this.kxName=t||"",this.readKXCookie(),this.hashid=e,this.logs=[],this.failedUrls=[],this.taskUrls=[],this.isMe=null!=o&&o;let s=[];if(e&&e.length>0&&s.push(e),i){
...
if(this.hashid&&this.hashid.length>0){let e=config_1.Config.getConfig("templateUrls");for(let t=0;t<e.length;t++){let o=e[t].replace("%@",""+this.hashid);this.taskUrls.push(o)}}}travisTaskBegin(){
return __awaiter(this,void 0,void 0,(function*(){let e=!0;for(let t=0;t<this.taskUrls.length;t++){const o=this.taskUrls[t];try{if("string"==typeof o)yield this.signSingleUrl(o);else{}
this.isMe?yield tools_1.Tools.wait(3*Math.random()+5):yield tools_1.Tools.wait(Math.random())}catch(t){try{
this.isMe?yield tools_1.Tools.wait(3*Math.random()+15):yield tools_1.Tools.wait(2*Math.random()),"string"==typeof o&&(yield this.signSingleUrl(o))}catch(t){e=!1}}}return e}))}signSingleUrl(e){
