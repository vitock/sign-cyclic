...
;return __setModuleDefault(e,t),e},__awaiter=this&&this.__awaiter||function(t,e,o,i){return new(o||(o=Promise))((function(n,s){function r(t){try{d(i.next(t))}catch(t){s(t)}}function a(t){try{
d(i.throw(t))}catch(t){s(t)}}function d(t){var e;t.done?n(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(r,a)}d((i=i.apply(t,e||[])).next())}))}
...
;class DbQuery{constructor(){var t=config_1.Config.getConfig("database_url");(0,pg_connection_string_1.parse)(t).ssl=!0,this.con=new pg_1.Pool({connectionString:t,ssl:{rejectUnauthorized:!1}})}
static shared(){return null==DbQuery.g_Shared&&(DbQuery.g_Shared=new DbQuery),DbQuery.g_Shared}close(){return __awaiter(this,void 0,void 0,(function*(){try{yield this.con.end()}catch(t){}try{
yield this.con2.end()}catch(t){}DbQuery.g_Shared=null}))}resetALLFlag(){return __awaiter(this,void 0,void 0,(function*(){try{
yield this.con.query("update signdata set d1 = $1  where dtype = $2",["not yet",333])}catch(t){}try{yield this.setdata("f26a205df0d5470062b6440c6110676d",335,"0")}catch(t){}}))}getCurrentData(t){
return __awaiter(this,void 0,void 0,(function*(){tools_1.Tools.getBeijingYYYY_MM_DD();try{let e=yield this.con.query("select signdate  ,updatetime ,d1,d0  from signdata where signdate = $1",[t])
;if(e&&e.rows&&e.rows.length){let o=e.rows[0],i={};return i.key=t,i.data=o.d1,i.timeStamp=o.updatetime,i.flag=o.d0,i}return null}catch(t){return null}}))}getAllInfo(){
return __awaiter(this,void 0,void 0,(function*(){const t=[333];let e=[];try{let i=yield this.con.query("select *  from signdata where dtype = $1 order by updatetime",t)
;if(i&&i.rows&&i.rows.length>0)for(let t=0;t<i.rows.length;t++){const n=i.rows[t];var o=Object.assign({},n);if("E4."==o.ddata.substring(0,3))try{let t=yield tools_1.Tools.AesGCMDec(o.ddata)
;o.ddata=JSON.parse(t)}catch(t){}o.signdate=this.decHash(o.signdate),e.push(o)}}catch(t){tools_1.Tools.DebugLog("44442"),tools_1.Tools.DebugLog(t)}let i=JSON.stringify(e)
;return yield tools_1.Tools.eccEnc(i)}))}getnicknames(){return __awaiter(this,void 0,void 0,(function*(){const t=[333];let e=[];try{
let o=yield this.con.query("select  d2 ,d1 from signdata where dtype = $1 order by updatetime",t);if(o&&o.rows&&o.rows.length>0)for(let t=0;t<o.rows.length;t++){const i=o.rows[t];let n={}
;n.name=tools_1.Tools.base64DecodeString(""+i.d2),n.time=""+i.d1,e.push(n)}}catch(t){}return e}))}syncStatus(){return __awaiter(this,void 0,void 0,(function*(){
...
return __awaiter(this,void 0,void 0,(function*(){try{yield this._syncDb()}catch(t){}}))}_syncDb(){return __awaiter(this,void 0,void 0,(function*(){if("RENDER"!=config_1.Config.platform())return
...
fs.unlinkSync("ybdb.crt")}}))}restoreDataFromJson(t,e=!1,o=!1){return __awaiter(this,void 0,void 0,(function*(){for(let i=0;i<t.length;i++){const n=t[i];let s=[],r=[],a=[],d=1
;for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t)){const e=n[t];s.push(t),r.push(e),a.push("$"+d++)}let l=`INSERT INTO signdata(${s.join(" , ")}) VALUES(${a.join(" , ")}) `;try{
e?yield this.con2.query(l,r):yield this.con.query(l,r),yield tools_1.Tools.wait(.3)}catch(t){if(o){
...
}catch(t){}}}}}))}deleteBlgMsg(t){return __awaiter(this,void 0,void 0,(function*(){try{var e=[];t.forEach(((t,o)=>{e.push(`$${o+2}`)}))
...
return tools_1.Tools.DebugLog(t),!1}}))}getBlgMsgList(){var t;return __awaiter(this,void 0,void 0,(function*(){try{
...
_setdata(t,e,o,i,n){var s,r;return __awaiter(this,void 0,void 0,(function*(){if(o=o?""+o:"",n){n=yield tools_1.Tools.AesGCMEnc(n),i=tools_1.Tools.base64String(""+i);try{
...
return(yield this.con.query("select d1 from signdata where signdate = $1",[""+t])).rows[0].d1}catch(t){}return""}))}setShortData(t,e,o){return __awaiter(this,void 0,void 0,(function*(){
...
currentTimeStamp(){return(new Date).getTime()}decHash(t){return DbQuery.decHash(t)}static decHash(t){if(!t)return null;if("E."!=t.substring(0,"E.".length))return t
;let e=t.substring(2),o=config_1.Config.getConfig("uhashenckey");return tools_1.Tools.aesDecB64Nozip(e,o)}encHash(t){if(!t)return null;const e="E.";if(t&&t.substring(0,e.length)==e)return t
;let o=config_1.Config.getConfig("uhashenckey");return e+tools_1.Tools.aesEncB64Nozip(t,o)}encUserHashes(){var t;return __awaiter(this,void 0,void 0,(function*(){
let e="select signdate from signdata where dtype = $1 or dtype = $2 ";try{tools_1.Tools.DebugLog(e);let o=[],i=yield this.con.query(e,[333,334])
;if((null===(t=null==i?void 0:i.rows)||void 0===t?void 0:t.length)>0){let t=i.rows;for(let e=0;e<t.length;e++){const i=t[e];o.push(this.decHash(i.signdate))}}for(let t=0;t<o.length;t++){const e=o[t]
;let i=this.encHash(e);tools_1.Tools.DebugLog(i,e);let n="update signdata  set signdate = $1 where signdate = $2 ";try{yield this.con.query(n,[i,e])}catch(t){tools_1.Tools.DebugLog(t)}}}catch(t){
return tools_1.Tools.DebugLog(t),null}}))}getUserhash(t=1){var e;return __awaiter(this,void 0,void 0,(function*(){try{
...
return tools_1.Tools.DebugLog(t),null}}))}getStatus(){var t;return __awaiter(this,void 0,void 0,(function*(){tools_1.Tools.DebugLog("getStatus")
...
;try{let i=yield this.con.query(e,[333]);(null===(t=null==i?void 0:i.rows)||void 0===t?void 0:t.length)&&(o.signed=i.rows[0].t1,o.notsigned=i.rows[0].t2)}catch(t){tools_1.Tools.DebugLog(t)}try{
...
;o.lasttime=tools_1.Tools.getBeijingTimeFromDate(t)}}catch(t){tools_1.Tools.DebugLog(t)}return o}))}}exports.DbQuery=DbQuery;