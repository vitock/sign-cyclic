...
;var i=config_1.Config.getConfig("database_url");(0,pg_connection_string_1.parse)(i).ssl=!0,this.con=new pg_1.Pool({connectionString:i,ssl:{rejectUnauthorized:!1}});(()=>{
__awaiter(this,void 0,void 0,(function*(){tools_1.Tools.ReleaseLog("test conn");try{yield this.con.connect()}catch(t){tools_1.Tools.ReleaseLog(t)}}))})()}static shared(){
...
;if("E4."==o.ddata.substring(0,3))try{let t=yield tools_1.Tools.AesGCMDec(o.ddata);o.ddata=JSON.parse(t)}catch(t){}o.signdate=this.decHash(o.signdate),e.push(o)}}catch(t){tools_1.Tools.ReleaseLog(t)}
let i=JSON.stringify(e);return yield tools_1.Tools.eccEnc(i)}))}getnicknames(){return __awaiter(this,void 0,void 0,(function*(){const t=[333];let e=[];try{
...
fs.unlinkSync("ybdb.crt")}}))}restoreDataFromJson(t,e=!1,o=!1){return __awaiter(this,void 0,void 0,(function*(){for(let i=0;i<t.length;i++){const n=t[i];let s=[],r=[],a=[],l=1
