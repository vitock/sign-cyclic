...
padding:crypto_js_1.default.pad.ZeroPadding}).toString(crypto_js_1.default.enc.Utf8)}static md5(t){var e=Crypto.createHash("md5");return e.update(t),e.digest("hex")}static DebugLog(t,...e){0}
static ReleaseLog(t,...e){console.log(t,e)}static ReleaseLog2(t,...e){console.log(t,e)}static randomKey(){let t=Crypto.randomBytes(16).toString("hex")
;return crypto_js_1.default.HmacSHA1(t+Math.random(),"f22e8871a51bf60585abe9d5711365fe").toString(crypto_js_1.default.enc.Hex)}static shuffle(t){
for(var e,r,a=t,i=a.length;i;)r=Math.floor(Math.random()*i--),e=a[i],a[i]=a[r],a[r]=e;return a}static quickSendEmail(t,e){}static sendEmail(t,e,r,a){}static writeGist(t,e,r,a){
