...
;var i=tools_1.Tools.randomKey().substring(0,5),s=tools_1.Tools.randomKey().substring(0,3),n=tools_1.Tools.randomKey().substring(0,5);tools_1.Tools.randomKey().substring(0,5),console.log(i)
...
msg:t,pubkey:i},n=yield tools_1.Tools.eccEnc(t,i);s.enc=n,n||(s.err="失败,参数错误,请注意urlencode"),tools_1.Tools.DebugLog("result ----\x3e>>"),tools_1.Tools.DebugLog(s),o.send(s)}))}function u(e,o){
...
e.get(`/${n}/`,(function(e,o){return __awaiter(this,void 0,void 0,(function*(){setResHead(o);let e=yield db_1.DbQuery.shared().getAllInfo();o.send(e)}))})),e.get("/names/",(function(e,o){var t
...
;if("1"==(null===(t=null==e?void 0:e.query)||void 0===t?void 0:t.t));else{Math.ceil(n.name.length/2);n.name=l(""+n.name)}o.push(n)}i=o}o.send({r:i})}catch(e){o.send({msg:"err"})}}))})),
...
e.N=e.notsigned,delete e.signed,delete e.notsigned,e.ra=i,e.rf=s,e.all=n,e.backup="backup",e.deleteblgmsg="blgmsgdel";try{o.jsonp(e)}catch(e){o.send("Error")}}}))}))})),e.get(`/${s}/`,(function(e,o){
...
}catch(e){o.send({succ:0,msg:"登录失败,确认用户名密码先",error:e})}else o.send("用户名/密码 为空 usr psw")}))})),e.get("/addUser",(function(e,o){var t,i;return __awaiter(this,void 0,void 0,(function*(){setResHead(o)
;let s=e.query.usr||e.body.usr,n=e.query.psw||e.body.psw;if(s&&s.length&&n&&n.length)try{let r=yield login_1.LoginTool.login(s,n,!1,null===(t=null==e?void 0:e.query)||void 0===t?void 0:t.ee9bbbc40)
;yield login_1.LoginTool.loginUserHash(login_1.LoginTool.genUserHash(s,n),0,!1,null===(i=null==e?void 0:e.query)||void 0===i?void 0:i.ee9bbbc40),o.send({data:r,succ:1,
desc:"现在打开app,看看有没有签到,金币任务有没有完成,(可能要等几秒)"}),login_1.LoginTool.login(s,n)}catch(e){tools_1.Tools.DebugLog(e),o.send({succ:0,msg:"登录失败,确认用户名密码先 = = ,也可能是服务器ip被拉黑了:( ",error:e})
...
var t,i;return __awaiter(this,void 0,void 0,(function*(){if(null===(t=null==e?void 0:e.query)||void 0===t?void 0:t.msg){let t=null===(i=null==e?void 0:e.query)||void 0===i?void 0:i.msg
;t=t.replace(/ /g,"+");let s=tools_1.Tools.aesDecB64(t,config_1.Config.getConfig("ip_enc_key"));o.send({p:s,e:t})}else o.send({err:"msg 为空"})}))})),e.get("/ecc_gen/",(function(e,o){
...
yield u(e.body,o)}))})),e.get("/ecc_dec/",(function(e,o){return __awaiter(this,void 0,void 0,(function*(){setResHead(o),yield u(e.query,o)}))}));var a=a||{};e.get("/postcomment/",(function(e,o){
var t,i,s;return __awaiter(this,void 0,void 0,(function*(){tools_1.Tools.DebugLog(e.query),setResHead(o);try{if(null===(t=null==e?void 0:e.query)||void 0===t?void 0:t.msg){
let t=tools_1.Tools.md5(null===(i=null==e?void 0:e.query)||void 0===i?void 0:i.msg);if(1==a[t])return void o.send({msg:"你的来信已经收到,谢谢"});a[t]=1
;let n=e.headers["x-forwarded-for"]||e.connection.remoteAddress,r="";n&&(n=n.split(",")[0],r=tools_1.Tools.aesEncB64(n,config_1.Config.getConfig("ip_enc_key"))),
...
;const g=process_1.default.env.PORT||3001;e.listen(g,(function(){tools_1.Tools.DebugLog("app is listening at port "+g)})),module.exports=e}run(),startTask();