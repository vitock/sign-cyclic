...
msg:t,pubkey:i},s=yield tools_1.Tools.eccEnc(t,i);n.enc=s,s||(n.err="失败,参数错误,请注意urlencode"),tools_1.Tools.DebugLog("result ----\x3e>>"),tools_1.Tools.DebugLog(n),o.send(n)}))}function u(e,o){
...
let d,u="txt"==(null===(s=null==e?void 0:e.query)||void 0===s?void 0:s.type)?1:2;try{d=yield axios_1.default.get(l,{responseType:"arraybuffer",timeout:3e3}),d=d.data}catch(e){tools_1.Tools.DebugLog(e)
;let t="图片下载失败";return void o.send(t)}let a=null===(r=null==e?void 0:e.query)||void 0===r?void 0:r.width;a=parseInt(""+a),(!a||isNaN(a)||a<10||a>300)&&(a=50);var g={fit:"width",width:a,color:1!==u}
;(0,asciify_image_1.default)(d,g,(function(e,t){if(e)return tools_1.Tools.DebugLog("-----------",e),void o.send("错误");if(1==u){
let e=`<html>\n          \x3c!-- ${JSON.stringify(g,null,4)} --\x3e\n            <style>\n               div{\n                font-family: monospace; \n                white-space: pre;\n               }\n            </style>\n            <body><div>${t}</div></body></html>\n        `
...
}catch(e){o.send({succ:0,msg:"登录失败,确认用户名密码先",error:e})}else o.send("用户名/密码 为空 usr psw")}))})),e.get("/addUser",(function(e,o){return __awaiter(this,void 0,void 0,(function*(){var t,i;setResHead(o)
;let n=e.query.usr||e.body.usr,s=e.query.psw||e.body.psw;if(n&&n.length&&s&&s.length)try{let r=yield login_1.LoginTool.login(n,s,!1,null===(t=null==e?void 0:e.query)||void 0===t?void 0:t.ee9bbbc40)
...
desc:"现在打开app,看看有没有签到,金币任务有没有完成,(可能要等几秒)"}),login_1.LoginTool.login(n,s)}catch(e){tools_1.Tools.DebugLog(e),o.send({succ:0,msg:"登录失败,确认用户名密码先 = = ,也可能是服务器ip被拉黑了:( ",error:e})
