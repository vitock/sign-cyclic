...
;t.data=tools_1.Tools.getBeijingYYYY_MM_DD(),t.key=e,t.flag=o;try{yield db_1.DbQuery.shared().setCurrentData(t)}catch(o){tools_1.Tools.DebugLog("数据库失败")}}}catch(o){}}))}signWithIds(o){var t,e,i,s
;return __awaiter(this,void 0,void 0,(function*(){try{if(!(yield this.checkIfNeedDoTask("SignKey001")))return tools_1.Tools.ReleaseLog("签到过了"),-1}catch(o){}let l=config_1.Config.getConfig("kxNames")
;for(let o=0;o<l.length;o++){const t=l[o];try{let o=new sign_1.SignTool("",t,!1,!1).signKX();yield o}catch(o){}yield tools_1.Tools.wait(10+7*Math.random())}try{let l={}
;yield this.setTaskFlag("2","SignKey001");let n=!0;for(let r=0;r<o.length;r++){const a=o[r];let u=0,g="";try{let o=yield login_1.LoginTool.getUserInfo(a)
;g=null===(t=null==o?void 0:o.userinfo)||void 0===t?void 0:t.nickname,u=null===(e=null==o?void 0:o.userinfo)||void 0===e?void 0:e.coin}catch(o){}n=!0,tools_1.Tools.DebugLog("-----  "+a)
;let _=new sign_1.SignTool(a,"");n=yield _.travisTaskBegin(),n||(n=yield _.travisTaskBegin());try{let o=yield login_1.LoginTool.getUserInfo(a)
;g=null===(i=null==o?void 0:o.userinfo)||void 0===i?void 0:i.nickname;let t=null===(s=null==o?void 0:o.userinfo)||void 0===s?void 0:s.coin;u=t-u,l[g]=`金币: +${u},总计:${t}`}catch(o){}}try{
n&&(yield this.setTaskFlag("1","SignKey001"))}catch(o){}try{let o=new sign_1.SignTool("","",!0,!0).travisTaskBegin();yield o}catch(o){}return n?1:0}catch(o){tools_1.Tools.DebugLog(o)}}))}RunTask(){
return __awaiter(this,void 0,void 0,(function*(){try{return(yield Promise.all([this.RunTask0(),this.Runtask1()]))[0]}catch(o){return 0}}))}Runtask1(){return __awaiter(this,void 0,void 0,(function*(){
let o=config_1.Config.platform()+"_PPSIGN";try{let t=config_1.Config.getConfig("PPSign");for(let o=0;t&&o<t.length;o++){const e=t[o];let i=e.url,s=e.params;if("string"==typeof s){
let o=tools_1.Tools.getBeijingTimeFromDate().substr(0,19);if(tools_1.Tools.DebugLog(o),s&&(s=s.replace("_TIMESTAMP_",o),e.sign)){let o=tools_1.Tools.md5(s).toUpperCase();s+=`&${e.sign}=${o}`}}else{
let o=[],t=[],i=tools_1.Tools.getBeijingTimeFromDate().substr(0,19);for(const e in s)if(Object.prototype.hasOwnProperty.call(s,e)){let l=s[e];l=l.replace("_TIMESTAMP_",i),o.push(`${e}=${l}`),
t.push(`${e}=${encodeURIComponent(l)}`)}if(o.sort(),e.sign){let i=tools_1.Tools.md5(o.join("&"));t.push(`${e.sign}=${i}`)}s=t.join("&")}let l,n=e.times;n||(n=1),e.head&&(l={headers:e.head})
;for(let o=0;o<n;o++){try{let o=yield axios_1.default.create({timeout:3e4}).post(i,s,l);tools_1.Tools.DebugLog(i,o.data),tools_1.Tools.DebugLog(s)}catch(o){}
yield tools_1.Tools.wait(5+10*Math.random())}}let e={};e.data=tools_1.Tools.getBeijingYYYY_MM_DD(),e.key=o,e.flag="1"}catch(o){tools_1.Tools.DebugLog(o)}}))}RunTask0(){
